...
namespace MidnightNohit.Core.Systems.MNLSystems.Sets
{
    ...
    public static class DeathSet
    {
        public static Dictionary<int, int> DeathMNLs => new()
        {
            ...
            [ModContent.NPCType<AquaticScourgeHead>()] = 3600,
        ...
        {
            MNLSet deathset = new(DeathMNLs, () =>
            {
                if (!CalamityWorld.death)
                    return MNLWeights.NoWeight;

                return MNLWeights.Death;
            });
            MNLsHandler.RegisterSet(deathset);
        }
    }
