...
namespace MidnightNohit.Core.Systems.MNLSystems.Sets
{
    ...
    public static class InfSet
    {
        public static Dictionary<int, int> InfernumMNLs => new()
        {
            ...
            [ModContent.NPCType<PrimordialWyrmHead>()] = 5700,
        ...
        {
            MNLSet infset = new(InfernumMNLs, () =>
            {
                if (!WorldSaveSystem.InfernumModeEnabled)
                    return MNLWeights.NoWeight;

                return MNLWeights.Infernum;
            });
            MNLsHandler.RegisterSet(infset);
        }
    }
}
