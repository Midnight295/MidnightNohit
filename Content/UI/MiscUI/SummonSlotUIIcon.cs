...
namespace MidnightNohit.Content.UI.MiscUI
{
    public class SummonSlotUIIcon
    {
        ...
        public static void Draw(SpriteBatch spriteBatch)
        {
            ...
            Texture2D Icon = ModContent.Request<Texture2D>("MidnightNohit/Content/UI/MiscUI/summonUI", (AssetRequestMode)2).Value;
            Texture2D HoverIcon = ModContent.Request<Texture2D>("MidnightNohit/Content/UI/MiscUI/summonUIHover", (AssetRequestMode)2).Value;
            ...
            if (isHovering)
            {
                ...
                defaultInterpolatedStringHandler.AppendFormatted(Language.GetTextValue($"Mods.MidnightNohit.UI.SummonUI.Max") + " " + maxMinions);
                defaultInterpolatedStringHandler.AppendLiteral("\n");
                defaultInterpolatedStringHandler.AppendFormatted(Language.GetTextValue($"Mods.MidnightNohit.UI.SummonUI.Free") + " " + freeMinions);
                defaultInterpolatedStringHandler.AppendLiteral("\n");
                defaultInterpolatedStringHandler.AppendFormatted(Language.GetTextValue($"Mods.MidnightNohit.UI.SummonUI.Used") + " " + amountOfMinions);
